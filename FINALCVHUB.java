...
class Oy
{
	...
	void OYO()
	{
		...
		{
			System.out.println();
			System.out.print(r+blk+"\t\t\t\t\t\t\t\tPOO RAA PILLA PICHUKA -_-"+rst);
		}
	}
	void friends()
	{
	...
	void hyd()
	{
		...
		else if(a==2)
		{
			...
			System.out.println();
			System.out.println(g+"\t\t\t\t\t\t\tReview : "+rst);
			System.out.println("\t\t\t\t\t\t\t *BB:Room is so small and all things are not working.");
			System.out.println("\t\t\t\t\t\t\t *Well maintained room but room service may be better.");
			System.out.println();
			r2();
		}
		else if(a==3)
	...
	void bng()
	{
		...
		else if(a==3)
		{
			...
			System.out.println();
			System.out.println(g+"\t\t\t\t\t\t\tReview : "+rst);
			System.out.println("\t\t\t\t\t\t\t *Neat and Clean with affordable price.");
	...
	void goa()
	{
		...
		if(a==1)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Dinesh:Excellent condition of the rooms.");
			System.out.println();
			r1();
		}
		else if(a==2)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Very high price.");
			System.out.println();
			r2();
		}
		else if(a==3)
	...
	void viz()
	{
		...
		if(a==1)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *AbhiNeat and Clean with affordable price.");
			System.out.println();
			r1();
		}
		else if(a==2)
		...
		else if(a==4)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Prabakat:Beds are comfortable with spring action.");
			System.out.println();
			r4();
		}
		else
	...
	void DAR()
	{
		...
		else if(a==3)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Rooms are not same as shown.");
			System.out.println();
			r3();
		}
		else if(a==4)
	...
	void KASHMIR()
	{
		...
		if(a==1)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Praveen:Room is amazing zing zing.");
			System.out.println();
			r1();
		}
		else if(a==2)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Only Jasmine smell.");
			System.out.println();
			r2();
		}
		else if(a==3)
	...
	void OOTY()
	{
		...
		if(a==1)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Neat and Clean.");
			System.out.println();
			r1();
		}
		else if(a==2)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Outside is so cool but room is very hot.");
			System.out.println();
			r2();
		}
		else if(a==3)
		{
			...
			System.out.println(g+"\t\t\t\t\t\t\tReview : "+rst);
			System.out.println("\t\t\t\t\t\t\t *Neat and Clean .");
			System.out.println("\t\t\t\t\t\t\t *Maintanence is not so good.");
			System.out.println();
			r3();
		}
		else if(a==4)
		{
			...
			System.out.println();
			System.out.println(g+"\t\t\t\t\t\t\tReview : +rst");
			System.out.println("\t\t\t\t\t\t\t *Prabakar:Beds are not so strong.");
			System.out.println("\t\t\t\t\t\t\t *Rooms have very less space.");
			System.out.println();
			r4();
		}
		else
	...
	void LADAKH()
	{
		...
		if(a==1)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *More Disturbances are getting from outside.");
			System.out.println();
			r1();
		}
		else if(a==2)
		...
		else if(a==3)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Prabakar:Kutha Paagalu undi.");
			System.out.println();
			r3();
		}
		else if(a==4)
		{
			...
			System.out.println("\t\t\t\t\t\t\t *Anil:No Privacy For The Couples.");
			System.out.println();
			r4();
		}
		else
...
class CVHUB
{
	...
	static void display()
	{
		...
		for(int i=1;i<=15;i++)
		{
			...
			for(int j=1;j<=20;j++)
			{
				System.out.print(cv.blink+" ");cv.sleep2();
			}
			for(int j=21;j<=40;j++)
			{
				if(i==1 || i==a || j==21)
				{
					System.out.print(cv.blink+A_YELLOW+"$"+A_RESET);cv.sleep2();
				}
				else if((i==3 && (j!=22 && j!=23)) || (j==24 && i!=2 && i!=14) || (i==13 && j!=23 && j!=22))
				{
					System.out.print(cv.blink+B_RED+"&"+A_RESET);cv.sleep2();
				}
				else
				{
					System.out.print(cv.blink+C_RED_B+" "+A_RESET);cv.sleep2();
				}
			}
			for(int j=41;j<=65;j++)
			{
				...
				else if((i==3 && j==44)||(i==3 && j==64)||(i==4 && (j==45||j==63))||(i==5 && (j==46||j==62))||(i==6 && (j==47||j==61))||(i==7 && (j==48||j==60))||(i==8 && (j==49||j==59))||(i==9 && (j==50||j==58))||(i==10 && (j==51||j==57))||(i==11 && (j==52||j==56))||(i==12 && (j==53||j==55)))
				{
					System.out.print(cv.blink+B_RED+"#"+A_RESET);cv.sleep2();
				}
				else if(i==13 && j==54)
			...
			for(int j=66;j<=86;j++)
			{
				...
				else if((i==14 && j==69)||(i==8 && j==66)||(i==8 && j==67)||(i==8 && j==68)||(i==14&&j==86)||(i==13&&j==86))
				{
					System.out.print(cv.blink+D_GREEN_B+" "+A_RESET);cv.sleep2();
				}
				else if((j==69 && (i!=2||i==3))||(i==13&&j==69)||(i==8 &&j!=66)||(j==86&&(i!=2))||(i==13 && j==86))
				{
					System.out.print(cv.blink+B_RED+"@"+A_RESET);cv.sleep2();
				}
				else
			...
			for(int j=87;j<=110;j++)
			{
				if(i==1 || i==a)
				{
					System.out.print(cv.blink+A_YELLOW+"$"+A_RESET);cv.sleep2();
				}
				else if((i==2 && j==90)||(i==14 && j==90))
				{
					System.out.print(cv.blink+D_GREEN_B+" "+A_RESET);cv.sleep2();
				}
				else if((j==90)||(i==13 && j==90)||(i==13&&(j<=109&&j>89))||(j==109&&(i!=2 && i!=14)))
				{
					System.out.print(cv.blink+B_RED+"%"+A_RESET);cv.sleep2();
				}
				else if(i==13&& j==87)
			...
			for(int j=111;j<=133;j++)
			{
				...
				else if((j==113&&(i!=2&&i!=14))||(i==3&&(j>=113&&j<=130))||(j==130&&(i!=2&&i!=14))||(i==13&&(j>=113&&j<=130))||(i==8&&(j>=113&&j<=130)))
				{
					System.out.print(cv.blink+B_RED+"$"+A_RESET);cv.sleep2();
				}
				else
				{
					System.out.print(cv.blink+D_GREEN_B+" "+A_RESET+cv.reset);cv.sleep2();
				}
			}
			System.out.println();
		}
	...
	{
		System.out.println(cv.yellow+"\n\n \t\t\t\t\t\t\t  W E L C O M E   T O   T H E   C V    H U B  "+cv.reset);
		display();
		System.out.println();
		System.out.println();
		project.M1();
